            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="row">
                    ...
                    <div class="row">
                       <div class="col-md-12">
                        <br>
                       <button id="adcAluno" style="float:right" class="checkout__btn-submit btn btn-primary">Adicionar aluno</button>
                            ...
                            <div class="table-responsive">
                                <table id="mytable" class="table table-bordred table-striped">
                                    ...
                                    <tbody>
                                    @foreach ($usr as $teste)

                                    <tr>
                                    <td><input type="checkbox" class="checkthis" /></td>
                                    <td>{{$teste['name']}}</td>
                                    <td>{{$teste['nascimento']}}</td>
                                    <td>{{$teste['contact']}}</td>
<!--                                     <td><p data-placement="top" data-toggle="tooltip" title="Edit"><button onclick='editUser(this)' id="{{$teste['name']}}" data-name="{{$teste['name']}}" name="{{$teste['name']}}" class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button></p></td>
 --><!--                                     <td><p data-placement="top" data-toggle="tooltip" title="Edit"><button onclick='addficha(this)' id="{{$teste['name']}}" name="{{$teste['name']}}" class="btn btn-primary btn-xs" data-title="addficha" data-toggle="modal" data-target="#addficha" ><span class="glyphicon glyphicon-file"></span></button></p></td>
 -->                                    <!-- <td><p data-placement="top" data-toggle="tooltip" title="Edit"><button onclick='addTreino(this)' id="{{$teste['name']}}" name="{{$teste['name']}}" class="btn btn-primary btn-xs" data-title="addTreino" data-toggle="modal" data-target="#addTreino" ><span class="glyphicon glyphicon-file"></span></button></p></td>
                                    <td><p data-placement="top" data-toggle="tooltip" title="Delete"><button onclick='deleteUser(this)' id="{{$teste['name']}}" name="{{$teste['name']}}" class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-trash"></span></button></p></td>    
                                     -->         
                                     <td><a onclick='addTreino(this)' id="{{$teste['name']}}" name="{{$teste['name']}}" href="#"> &nbsp;&nbsp;&nbsp;<span  style="color:blue" class="glyphicon glyphicon-edit"></span></a>      
                                     <td><a onclick='addTreino(this)' id="{{$teste['name']}}" name="{{$teste['name']}}" href="#"> &nbsp;&nbsp;&nbsp;<span  style="color:#122143" class="glyphicon glyphicon-file"></span></a>                                                               
                                     <td><a onclick='addTreino(this)' id="{{$teste['name']}}" name="{{$teste['name']}}" href="#"> &nbsp;&nbsp;&nbsp;<span  style="color:122143" class="glyphicon glyphicon-file"></span></a>                                                               
                                     <td><a onclick='deleteUser(this)' id="{{$teste['name']}}" name="{{$teste['name']}}" href="#"> &nbsp;&nbsp;&nbsp;<span  style="color:red" class="glyphicon glyphicon-trash"></span></a>      
...
<script>
    ...
    function editUser(obj){
        window.location.replace('/aluno/edit/' + obj.id)
    }
    ...
    function addficha(obj){
        window.location.replace('/createFicha/' + obj.id)
    }
    
    function addTreino(obj){
        window.location.replace('/trainingDias/')
    }
    ...
    $(document).ready(function(){
        ...
        /* $("#editUser").click(function(){
            window.location.replace('/aluno/edit/' + document.querySelector("#editUser").name)
         }); */
