    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="logo">
                    <a hef="home.html"><img src="http://127.0.0.1:8002/logoo.png" alt="mb_logo" class="hidden-xs hidden-sm">
                    </a>
                </div>
                <div class="navi">
                    <ul>
                        ...
                        <div class="active" style='background: #122143 none repeat scroll 0 0;border-left: none;display: block; padding-left: 20px;height:420px'></div>    
                ...
                <div class="accordion" id="searchAccordion">
                    ...
                    <h5>
                        ...
                        <div class="accordion-heading">
                            ...
                            data-parent="#searchAccordion" href="#collapseOne">Editar Aluno</a>
                        </div>
                        </h5>
                            ...
                            <div class="accordion-inner">
                                ...
                                <form id="editAluno">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" style='height:30px' class="form-control" id="date" name='date' value="{{$aluno['nascimento']}}">
                                    </div>
                                    <div class="form-group">
                                        <label>Contato:</label>
                                        <input type="text" style='height:30px' data-mask="00/00/0000" class="form-control" id="contact" name='contact' value="{{$aluno['contact']}}">
                                    </div>
