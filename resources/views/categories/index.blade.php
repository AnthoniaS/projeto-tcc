                            ...
                            <div class="accordion-inner">
                               ...
                               <!--  <div class="accordion-heading">
                                ...
                                <table id="mytable" class="table table-bordred table-striped">
                                    ...
                                    <tr>
                                    <td><input style='box-shadow: 0 0 0 0;border: 0 none; outline:0;width:100px;background-color:#F8F8FF' onclick='abrecategoria(this)' name="{{$category}}" id="{{$category}}"  type="text" class="form-control form-control-sm" value="{{$category}}" ></input></td>
                                    <td><a onclick='verCategoria(this)' id="{{$category}}" name="{{$category}}" href="#"> <span class="glyphicon glyphicon-eye-open"></span></a>
                                    <td><a onclick='excluirCategoria(this)' id="{{$category}}" name="{{$category}}" href="#"> &nbsp;&nbsp;&nbsp;<span  style="color:red" class="glyphicon glyphicon-trash"></span></a>                                                               
...
<script>
    ...
    function verCategoria(obj){
        name = obj.id;
        window.location.replace('/addcateg/' + name)
