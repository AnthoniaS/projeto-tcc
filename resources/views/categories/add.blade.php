...
.inputteste{
    height:30px;width:200px;border:0;background-color:#F8F8FF;border-bottom:2px solid rgb(200,200,200);outline:0;
}
                ...
                <div class="accordion" id="searchAccordion">
                    ...
                    <h5>
                        ...
                        <div class="accordion-heading">
                            ...
                            data-parent="#searchAccordion" href="#collapseOne">Adicionar Exercicio de {{$tipo}}</a>
                        </div>
                        </h5>
                               ...
                               <!--  <div class="accordion-heading">
                                   ...
                                   <!--  <h1> Lista </h1>
                                    <div class="form-group">
                                        ...
                                        <input type="text" style='height:30px' class="form-control" id="exerc" name='exerc'>
                                    </div>
                                    <ul id="lista">

</ul>
<button  id="" name="ssasd" style='background:#122143' class="btn btn-primary" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-plus"></span></button>  

<button onclick="adicionar()"> <i class="fa-solid fa-plus"></i> Adicionar </button>
 -->
 ...
 <form id="addexerc">
                                ...
                                <div class="row">
                                    <div  style='width:160px' class="col-md-4 col-xs-3">
                                            <label style='width:200px'>Nome do exercicio:</label>
                                    </div>
                                    <div style='width:160px' class="col-md-4 col-xs-3">
                                            <input style='width:150px;height:30px' class="inputteste" id="exerc" name='exerc'>
                                    </div>
                                    <div class="col-md-4 col-xs-3">
                                        <button  id="" name="ssasd" type="button" style='background:#122143' class="btn btn-primary" onclick="adicionar()" ><span class="glyphicon glyphicon-plus"></span></button>  

                                    </div>
                                </div>
                        <div id="teste" style='margin:15px;'>  
                            <table style="width:400px"id="mytable" class="table table-bordred table-striped">
                                <thead>
...
<input id='tipo' name='tipo' type='hidden' value='{{$tipo}}'> </input>
</form>
...
<!-- 
                                    <div style='width:100%;'>
                                        <div style='position:relative;float:left;width:33.33333%;'class="form-group col-md-6">
                                        <label style='display:block;'>Nome do exercicio:
                                        <input type="text" style='display:block;' class="form-control" id="exerc" name='exerc'/>
                                   ...
                                   <button id='btsalva' style='background:#122143' class="btn btn-primary">Salvar</button>
...
<script>
    ...
    function adicionar(){
        let text = document.getElementById("exerc").value;
        let list = document.getElementById("lista").innerHTML;    
        list += "<tr><td><input type='text' style='box-shadow: 0 0 0 0;border: 0 none;outline:0;width:200px;background-color:#F8F8FF;color:#000000;font-weight: bold;' name='exercicios[]' value='" + text + "'></input></td> <td><p data-placement='top' data-toggle='tooltip' ><button onclick='deleteUser(this)' class='btn btn-danger btn-xs'  ><span class='glyphicon glyphicon-trash'></span></button></p></td></tr>"
        document.getElementById("lista").innerHTML = list;

        document.getElementById("exerc").value = "";
    }

    $(document).ready(function(){
 
   
        $("#btsalva").on("click", function(e) {
            e.preventDefault();
            $.ajax({
                type: "POST",
                url: '/adicionaExercicio',
                dataType: 'JSON',
                data: $("#addexerc").serialize(),
