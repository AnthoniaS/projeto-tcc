                            ...
                            <div class="accordion-inner">
                               ...
                               <!--  <div class="accordion-heading">
                                ...
                                <table id="mytable" class="table table-bordred table-striped">
                                    ...
                                    <tr>
                                    <td><input style='box-shadow: 0 0 0 0;border: 0 none; outline:0;width:100px;background-color:#F8F8FF' onclick='abrecategoria(this)' name="{{$category}}" type="text" class="form-control form-control-sm" value="{{$category}}" ></input></td>
                                    <td><p data-placement="top" title="Edit"><button style='background:#F8F8FF' onclick='addTreino(this)' id="" name="" class="btn btn-primary" ><span class="glyphicon glyphicon-file"></span></button></p></td>
                                    <td><p data-placement="top" title="Delete"><button onclick='deleteUser(this)' id="" name="" class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-trash"></span></button></p></td>    
