            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="row">
                    ...
                    <div class="row">
                       <div class="col-md-12">
                        <br>
                       <button id="addFicha" style="float:right" class="checkout__btn-submit btn btn-primary">Adicionar ficha</button>
                            ...
                            <div class="table-responsive">
                                <table id="mytable" class="table table-bordred table-striped">
                                    ...
                                    @if(isset($files))
                                        ...
                                        <td>{{$file['date']}}</td>
                                        <td>nada</td>
                                        <td><p data-placement="top" data-toggle="tooltip" title="Edit"><button  onclick='verFicha(this)' id="{{$file['name']}}" name="{{$file['name']}}" class="btn btn-primary btn-xs" data-title="verFicha" data-toggle="modal" data-target="#verFicha" ><span class="glyphicon glyphicon-pencil"></span></button></p></td>
                                        <td><p data-placement="top" data-toggle="tooltip" title="Delete"><button onclick='deleteFicha(this)' id="{{$file['name']}}" name="{{$file['name']}}" class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-trash"></span></button></p></td>    
                                        </tr>
                                        @endforeach
                                    @else
                                        <tr>
                                        <td>Ainda não tem fichas registradas</td>
                                        <td> </td>
                                        <td> </td>
                                        </tr>
                                    @endif
...
<script>
    ...
    function verFicha(obj){
        name = obj.id.replace(" ", "-");
        window.location.replace('/ficha/' + name)
    }
    function deleteFicha(obj){
        name = obj.id.replace(" ", "-");
        $.ajax({
                type: "POST",
                url: '/ficha/delete',
    ...
    $(document).ready(function(){
       ...
       /*  $("#verFicha").click(function(){
            name = document.querySelector("#verFicha").name.replace(" ", "-");
            window.location.replace('/ficha/' + name)
        }); */
        ...
        $("#addFicha").click(function(){
            window.location.replace('/createFicha')
        });
