            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <div class="active" style='background: #122143 none repeat scroll 0 0;border-left: none;display: block; padding-left: 20px;height:830px'></div>    
                        ...
                        <div id="collapseOne" class="accordion-body collapse in">
                            <div class="accordion-inner">
                                ...
                                <form id="editFicha">
                                    ...
                                    <h3>Ficha de anamnese, clíninca e funcional </h3>

                                    <div class="form-inline">
                                        <label><strong>Nome completo:&nbsp </strong></label>{{$aluno['name']}}
                                    </div>
                                
                                    <div class="form-inline">
                                        <label><strong>Data de nascimento:</strong></label> {{$aluno['date']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Profissão:</strong></label> {{$aluno['profission']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Atividade física semanal:</strong></label>
                                    </div>
                                    <div  class="form-inline">
                                        <label><strong>Frequência:</strong></label>
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Condição clínica cardiometabólica:</strong></label> {{$aluno['cardiometabolicCondition']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Condição clínica osteoarticular:</strong></label> {{$aluno['osteoarticularCondition']}}
                                    </div>
                                    <div class="form-inline">
                                    <label><strong>Faz uso de medicamentos: {{$aluno['selectMedicine']}}
                                    </div>

                                    </strong></label>
                                    @if($aluno['selectMedicine'] == 'sim')
                                        <div class="form-inline">
                                            <label><strong>Quais:</strong></label> {{$aluno['medicines']}}
                                        </div>
                                    @endif
                                    
                                    <div class="form-inline">
                                        <label><strong>Qual objetivo?</strong></label> {{$aluno['goal']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Data inicial:</strong></label> {{$aluno['initialDate']}}
                                    </div>
                                    ...
                                    <div class="form-inline">
                                        <label><strong>Peso:</strong></label> {{$aluno['weight']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Altura</strong></label> {{$aluno['height']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Circunferência abdominal:</strong></label> {{$aluno['circumAbdom']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Circunferência quadril:</strong></label> {{$aluno['circumHip']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Circunferência antebraço:</strong></label> {{$aluno['circumForearm']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Tríceps:</strong></label> {{$aluno['triceps']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Bíceps:</strong></label> {{$aluno['biceps']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Subescapular:</strong></label> {{$aluno['subscapular']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Axilar média:</strong></label> {{$aluno['middleAxillary']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Suprailíaca:</strong></label> {{$aluno['suprailiac']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Abd:</strong></label> {{$aluno['abd']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Coxa:</strong></label> {{$aluno['thigh']}}
                                    </div>
                                    <div class="form-inline">
                                        <label><strong>Panturrilha:</strong></label> {{$aluno['calf']}}
                                    </div>

                                    <div class="form-inline">
                                        <h4>Teste vo2 max:</h4> {{$aluno['testVo2']}}
                                    </div>
                                    <div class="form-inline">
                                        <h4>Teste tempo limite:</h4> {{$aluno['testLimit']}}
                                    </div>

                                    <div class="form-inline">
                                        <h4>Observações complementares  :</h4> {{$aluno['complementaryRemarks']}}
                                    </div> 
