                            ...
                            <div class="accordion-inner">
                                <form id="addtreino">
                                    ...
                                    <div class="form-inline">
                                        <label>Nome completo:&nbsp </label>saas
                                    </div>
                                    <div class="form-inline">
                                        <label>Data do Início:&nbsp </label>saassa
                                    </div>
                                    <div class="form-inline">
                                        <label>Objetivo:&nbsp </label>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <button  style='background:#122143;width:100px' class="btn btn-primary">Segunda <i class="fa fa-paste"></i></button>
                                    </div>
                                    <div class="form-group">
                                        <button  style='background:#122143;width:100px' class="btn btn-primary">Terça <i class="fa fa-paste"></i></button>
                                    </div>
                                    <div class="form-group">
                                        <button  style='background:#122143;width:100px' class="btn btn-primary">Quarta <i class="fa fa-paste"></i></button>
                                    </div>
                                    <div class="form-group">
                                        <button  style='background:#122143;width:100px' class="btn btn-primary">Quinta <i class="fa fa-paste"></i></button>
                                    </div>
                                    <div class="form-group">
                                        <button  style='background:#122143;width:100px' class="btn btn-primary">Sexta <i class="fa fa-paste"></i></button>
                                    </div>
