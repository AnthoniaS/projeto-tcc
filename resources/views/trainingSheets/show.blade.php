                        ...
                        <div id="collapseOne" class="accordion-body collapse in">
                            <div class="accordion-inner">
                                <form id="addtreino">
                                    ...
                                    <label>Rotina de treinos:</label>
                                    <br>


                                    <div id='treinos'>  
                                        <input style='box-shadow: 0 0 0 0;border: 0 none;outline:0;width:100%;background-color:#F8F8FF;font-weight: bold;color:#000000' type="text" name="title" class="form-control form-control-sm" value=" {{$treino['title']}}" ></input>
                                        <br>
                                        <br>
                                        @if(isset($treino['dia1'])) 
                                            @if(isset($treino['dia4']))    
                                                <div class="col-xs-2" style='width:200px'> 
                                            @elseif(isset($treino['dia5']))  
                                                <div class="col-xs-2" style='width:180px'> 
                                            @else
                                                <div class="col-xs-2" style='width:265px'> 
                                            @endif    
                                                <input style='box-shadow: 0 0 0 0;border: 0 none;outline:0;width:260px;background-color:#F8F8FF;color:#000000;font-weight: bold;' type="text" name="dia1" class="form-control form-control-sm" value="{{$treino['dia1']}}" ></input><br>
                                                @foreach($treino['exercdia1'] as $eexc)
                                        ...
                                        @if(isset($treino['dia2'])) 
                                            ...
                                            @else
                                                <div class="col-xs-2" style='width:265px'> 
                                            @endif    
                                                <input style='box-shadow: 0 0 0 0;border: 0 none;outline:0;width:260px;background-color:#F8F8FF;color:#000000;font-weight: bold;' type="text" name="dia2" class="form-control form-control-sm" value="{{$treino['dia2']}}" ></input><br>
                                                @foreach($treino['exercdia2'] as $eexc)
                                                <e contenteditable="true"><input style='box-shadow: 0 0 0 0;border: 0 none;outline:0;width:150px;background-color:#F8F8FF;color:#000000' type="text" name="exercdia2[]" class="form-control form-control-sm" value=" {{$eexc}}" ></input></e><br>                                                                
                                                @endforeach
                                                </div>  
                                                <div class="col-xs-2" style='width:1px;'> 
                                                    <div style='height: 170px;color:gray;border-left: 1px solid;width:1px;display: inline-block;' class="linha-vertical"></div>
                                        ...
                                        @if(isset($treino['dia3'])) 
                                            ...
                                            @else
                                                <div class="col-xs-2" style='width:265px'> 
                                            @endif    
                                                <input style='box-shadow: 0 0 0 0;border: 0 none;outline:0;width:260px;background-color:#F8F8FF;color:#000000;font-weight: bold;' type="text" name="dia3" class="form-control form-control-sm" value="{{$treino['dia3']}}" ></input><br>
                                                @foreach($treino['exercdia3'] as $eexc)
                                                <e contenteditable="true"><input style='box-shadow: 0 0 0 0;border: 0 none;outline:0;width:150px;background-color:#F8F8FF;color:#000000' type="text" name="exercdia3[]" class="form-control form-control-sm" value=" {{$eexc}}" ></input></e><br>                                                                
                                                @endforeach
                                                </div>  
                                                <div class="col-xs-2" style='width:1px;'> 
                                                    <div style='height: 170px;color:gray;border-left: 1px solid;width:1px;display: inline-block;' class="linha-vertical"></div>
                                        ...
                                        @if(isset($treino['dia4'])) 
                                            ...
                                            @else
                                                <div class="col-xs-2" style='width:265px'> 
                                            @endif    
                                                <input style='box-shadow: 0 0 0 0;border: 0 none;outline:0;width:260px;background-color:#F8F8FF;color:#000000;font-weight: bold;' type="text" name="dia4" class="form-control form-control-sm" value="{{$treino['dia4']}}" ></input><br>
                                                @foreach($treino['exercdia4'] as $eexc)
                                                <e contenteditable="true"><input style='box-shadow: 0 0 0 0;border: 0 none;outline:0;width:150px;background-color:#F8F8FF;color:#000000' type="text" name="exercdia4[]" class="form-control form-control-sm" value=" {{$eexc}}" ></input></e><br>                                                                
                                                @endforeach
                                                </div>  
                                                <div class="col-xs-2" style='width:1px;'> 
                                                    <div style='height: 170px;color:gray;border-left: 1px solid;width:1px;display: inline-block;' class="linha-vertical"></div>
                                        ...
                                        @if(isset($treino['dia5']))                    
                                            ...
                                            @else
                                                <div class="col-xs-2" style='width:265px'> 
                                            @endif                                                         
                                            <input style='box-shadow: 0 0 0 0;border: 0 none;outline:0;width:150px;background-color:#F8F8FF;color:#000000;font-weight: bold;' type="text" name="dia5" class="form-control form-control-sm" value="{{$treino['dia5']}}" ></input><br>
                                            @foreach($treino['exercdia5'] as $eexc)
                                            <e contenteditable="true"><input style='box-shadow: 0 0 0 0;border: 0 none;outline:0;width:150px;background-color:#F8F8FF;color:#000000' type="text" name="exercdia5[]" class="form-control form-control-sm" value=" {{$eexc}}" ></input></e><br>                                                           
                                            @endforeach
                                            </div>
                                        @else
                                        <div class="col-xs-2" style='width:100px;height:200px'></div>
                                        @endif
